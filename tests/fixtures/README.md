...
`codex-success.jsonl` and `claude-success.jsonl` were captured from the packaged
Codex 0.154.0 and Claude Code 2.1.119 CLIs using `tests/smoke_native_clis.py`.
